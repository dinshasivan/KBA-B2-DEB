...
const CoursePage = () => {
  ...
  return (
    ...
    (<div className="flex flex-row justify-end gap-4 mr-[205px] ">
      ...
      <button  className="flex bg-red-500 hover:bg-red-600 text-white font-bold  rounded-full h-10 w-32 focus:outline-none focus:shadow-outline  justify-center items-center" onClick={deleteCourse()}>Remove Course</button>
